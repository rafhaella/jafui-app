...
//        place.setCreatedBy(placeRequest.getCreatedBy());
//
...
//        responsePlace.setName(place.getName());
//        responsePlace.setAddress(place.getAddress());
//        responsePlace.setDescription(place.getDescription());
//        responsePlace.setRating(place.getRating());
//        responsePlace.setPhotos(place.getPhotos());
//        responsePlace.setCreatedBy(place.getCreatedBy());
...
//    }
    ...
    public Place updatePlace(String id, Place updatedPlace) throws Exception {
        ...
        try {
            ...
            if (updatedPlace.getCreatedBy() != null && !updatedPlace.getCreatedBy().isEmpty()) {
                place.setCreatedBy(updatedPlace.getCreatedBy());
            }
        } catch (Exception e) {
